...
import com.aks.study.ehcache.config.expiry.DefaultExpiry;
...
public class EhcacheConfig {
    ...
    private Map<String, CacheConfiguration<?, ?>> getCacheConfigurationMap() {
        ...
        cacheMap.put(EhcacheConfigurationConstants.PERSON_CACHE, createPersonEhCache(cacheEventListenerConfigurationBuilder));
    ...
    // Ehcache 생성
    private CacheConfiguration<String, Person> createPersonEhCache(CacheEventListenerConfigurationBuilder cacheEventListenerConfigurationBuilder) {
